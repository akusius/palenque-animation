...
public class FrameRendererTest {
  ...
  private static class TestG2D extends Graphics2D {
  ...
  /**
   * Összes kockára legeneráljuk
   */
  @Test
  public void test1() {
    Graphics2D g = new TestG2D();
    ...
    for (int frame = 0; frame <= mfn; frame++) {
      FrameInfo fi = FrameInfo.getFrameInfo(frame);
      FrameRenderer.renderFrame(fi, g, m, 1f, dim);
    }
  }
